...
public class IconEditField extends EditText{
    ...
    public IconEditField(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public IconEditField(Context context, AttributeSet attrs, int defStyleAttr) {
